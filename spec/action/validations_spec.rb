  ...
  describe "inbound validation" do
    ...
    context "contract failure" do
      ...
      it "fails" do
        ...
        expect(subject.exception).to be_a(Action::Contract::Violation::InboundValidation)
  ...
  describe "outbound validation" do
    ...
    context "contract failure" do
      ...
      it "fails" do
        expect(subject).to be_failure
        expect(subject.error).to eq("Something went wrong")
        expect(subject.exception).to be_a(Action::Contract::Violation::OutboundValidation)
        expect(subject.exception.errors).to be_a(ActiveModel::Errors)
    ...
    context "setting failure" do
      ...
      it "fails" do
        expect(subject).to be_failure
        expect(subject.error).to eq("Something went wrong")
        expect(subject.exception).to be_a(Action::Contract::Violation::InvalidExposure)
      end
    end
  end
